...
def args_parser():
    ...
    parser.add_argument('--server_ep', type=int, default=100,help="number of rounds of training at the server side")
    parser.add_argument('--model_same', type=int, default=0,
                        help='1 is all the clients share the same model')
    parser.add_argument('--epochs', type=int, default=500,
                        help="number of communication rounds")
    parser.add_argument('--sfine', type=int, default=10,
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', help="name \
                        of dataset")
    parser.add_argument('--public_dataset', type=str, default='mnist', help="name \
                        of public dataset")
